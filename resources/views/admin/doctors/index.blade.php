...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('admin.doctors.create') }}" class="bg-teal-600 hover:bg-teal-700 text-white px-5 py-2.5 rounded-xl font-medium transition flex items-center space-x-2">
